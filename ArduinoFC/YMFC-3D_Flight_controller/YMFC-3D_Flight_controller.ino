...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float pid_p_gain_roll = 0.1;               //Gain setting for the roll P-controller (1.3)
float pid_i_gain_roll = 0;              //Gain setting for the roll I-controller (0.3)
float pid_d_gain_roll = 5;                //Gain setting for the roll D-controller (15) my max was 28
...
//      digitalWrite(12, !digitalRead(12));            //Change the led status.
  ...
  //1260 / 1023 = 1.2317.
  //The variable battery_voltage holds 1070 if the battery voltage is 10.5V.
...
//  if(battery_voltage < 1070 && battery_voltage > 600)digitalWrite(12, HIGH);
